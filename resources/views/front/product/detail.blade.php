    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                    <a href="{{ asset('front/images/product/large/'.$productDetails['product_image'])}}">
                        <img src="{{ asset('front/images/product/large/'.$productDetails['product_image'])}}" alt="" width="500" height="500" />
                    </a>


                </div>
                <div class="thumbnails">
                    <a href="{{ asset('front/images/product/large/'.$productDetails['product_image'])}}" data-standard="{{ asset('front/images/product/small/'.$productDetails['product_image'])}}">
                        <img width="150" height="150"  src="{{ asset('front/images/product/small/'.$productDetails['product_image'])}}" alt="" />
                    </a>

                    @foreach($productDetails['images'] as $image)
                    <a href="{{ asset('front/images/product/large/'.$image['image'])}}" data-standard="{{ asset('front/images/product/small/'.$image['image'])}}">
                        <img  width="150" height="150" src="{{ asset('front/images/product/small/'.$image['image'])}}" alt="" />
                    </a>
                    @endforeach
                ...
                <div class="all-information-wrapper">
                    ...
                    <div class="section-1-title-breadcrumb-rating">
                        ...
                        <ul class="bread-crumb">
                            ...
                            <?php echo $categoryDetails['brandcrumb']; ?>
                        </ul>
                    ...
                    <div>Sold by <a href="/products/{{ $productDetails['vendor']['id'] }}">{{  ($productDetails['vendor']['vendorbussinessdetail']['shop_name'])}}</a></div>
                @endif
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active show" id="#video">
                            <div class="description-whole-container">
                                ...
                                <video controls>
                                   <source src="{{ url('front/Video/productvideo/'.$productDetails['product_video'])}}" type="video/mp4">
                                   </video>
                                @else
        ...
        <div class="detail-different-product-section u-s-p-t-80">
                            ...
                            <div class="item">
                                <div class="image-container">
                                    <a class="item-img-wrapper-link" href="{{ url('product/'.$product['id']) }}">
                                        <?php $product_image_path='front/images/product/small/'.$product['product_image']; ?>
                                        @if(!empty($product['product_image']) && file_exists($product_image_path))
                                        <img class="img-fluid" src="{{ asset($product_image_path)}}" alt="Product">
                                        @else
                                        <img class="img-fluid" src="{{ asset('front/images/product/small/noimage.png')}}" alt="Product">
                                        @endif
            ...
            <section class="section-maker">
                <div class="container">
                    <div class="sec-maker-header text-center">
                        <h3 class="sec-maker-h3">Recently View Products</h3>
                    </div>
                    <div class="slider-fouc">
                        <div class="products-slider owl-carousel" data-item="4">
