        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <div class="toolbar-sorter">
                        <div class="select-box-wrapper">
                            ...
                            <select  name= "sort" id="sort" class="select-box" >
                               ...
                               <!-- <option value="" @if(isset($_GET['sort']) && $_GET['sort']=="product_latest" )selected="" @endif >Sort By: Best Rating</option> -->
                            </select>
                        </div>
                    </div>
                    </form>
               ...
               <div class="filter_product">
                @include('front.product.ajaxproductslisting')
               </div>
                @if(isset($_Get['sort']))
                <div>{{ $categoryProducts->append(['sort'=>$_GET['sort']])->links()}}</div>
                @else
